...
int main()
{
    ...
    while (1)
    {
        ...
        {
            printf("\nSuccess: Received  message from powerSupply\n");
            ...
            printf("Pending: Getting system information...\n");
            ...
            {
                printf("Success: Receive information from powerSupplyInfoAccess\n");
            ...
            printf("Pending: Getting device information...\n");
            ...
            if (msgrcv(msgId4, &message4, sizeof(message4), 1, 0) != -1)
            {
                printf("Success: Get device infomation from powerSupplyInfoAccess..\n");
                memset(infoBuffer, 0, sizeof(infoBuffer));
                strcpy(infoBuffer, message4.mesg_text);
            ...
            if (strcmp(requestedMode, equipInfo.status) == 0)
            {
                ...
                printf("Success: Sent message to powerSupply...\n");
            }
            ...
            else
            {
                ...
                else // nếu cần cung cấp > hạn mức
                {
                    ...
                    msgsnd(msgId2, &message2, sizeof(message2.mesg_text), 0);
                    printf("Success: Sent message to powerSupplyInfoAccess\n");
